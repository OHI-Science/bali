...
#health mangrove is derived from NDVI data
#calculated from landsat 8
#################################################
...
indir <- dir_scripts
		...
		## save data layer
		write_csv(dat, paste(directory, "prep/", toupper(goal), "/", goal, "_", variable, "_health_ndvi_", region, year, ".csv", sep = ""))
		write_csv(dat, paste(directory, "region2017/layers/", goal, "_", variable, "_health_ndvi_", region, year, ".csv", sep = ""))
